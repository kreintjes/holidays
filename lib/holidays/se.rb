...
module Holidays
  ...
  module SE # :nodoc:
    ...
    def self.holidays_by_month
      {
              0 => [{:function => lambda { |year| Holidays.easter(year)-2 }, :function_id => "easter(year)-2", :key => "", :name => "Långfredagen", :regions => [:se]},
      ...
      1 => [{:mday => 1, :key => "", :name => "Nyårsdagen", :regions => [:se]},
            {:mday => 6, :key => "", :name => "Trettondedag jul", :regions => [:se]}],
      5 => [{:mday => 1, :key => "", :name => "Första maj", :regions => [:se]}],
      6 => [{:mday => 6, :key => "", :name => "Nationaldagen", :regions => [:se]},
      ...
      12 => [{:mday => 25, :key => "", :name => "Juldagen", :regions => [:se]},
